...
-- [1002번 팀: 뷰티 컬렉티브] (기존: 뷰티지니, 일상브이로거 소속)
-- *규칙에 따라 일상브이로거(2006)가 있으므로 직원만 추가
(1003, 1002, 1004), -- 최담당 (1002번 팀 추가 소속)
(1004, 1002, 1006), -- 강마케팅 (1002번 팀 추가 소속)

-- [1003번 팀: 먹방 유니버스] (기존: 또간집, 먹보PD 소속)
(1005, 1003, 1003), -- 박매니저 (중복 소속: 1001, 1003)
(1006, 1003, 1005), -- 정관리 (1003번 팀 추가 소속)

-- [1004번 팀: 테크 리뷰어즈] (기존: 테크리뷰어, 감스트 소속)
-- *감스트(2001)는 1001번 팀의 메인이므로 여기선 직원으로 대체하거나 유지
(1007, 1004, 1007), -- 윤개발 (1004번 팀 추가 소속)
(1008, 1004, 1012); -- Emma Wilson (1004번 팀 추가 소속)
