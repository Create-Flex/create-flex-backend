...
public interface AdvertisementApi {
        ...
        @Operation(summary = "광고 캠페인 등록", description = "새로운 광고 캠페인을 등록합니다. 초기 상태는 WAITING(대기중)입니다.", security = @SecurityRequirement(name = "JWT"), responses = {
        ...
        @Operation(summary = "내 담당 크리에이터 광고 캠페인 목록 조회 (매니저용)", description = "로그인한 매니저가 담당하는 크리에이터들의 광고 캠페인 목록을 조회합니다. 필터를 통해 상태별 조회가 가능합니다.", security = @SecurityRequirement(name = "JWT"), responses = {
